		...
		<div className="flex w-8/12 mx-auto">
			<div className="relative flex justify-center">
				...
				<div className="grid md:flex">
					...
					/>
					<div className="grid md:items-center md:content-center md:translate-y-[50%] md:mx-auto md:absolute md:rounded-2xl md:h-3/6 md:bg-[rgb(217,217,217,0.85)] md:w-3/5">
						<img
							src="/logo.webp"
							className="h-12 md:h-24 mx-auto md:mb-3"
							alt="Yavo capital Logo"
						/>
						<p className="w-9/12 mx-auto my-3 sm:text-xl md:w-10/12 lg:text-2xl lg:mt-12 xl:text-3xl xl:p-6">
						...
						<p className="w-10/12 mx-auto my-3 sm:text-xl lg:text-2xl">
							<SpanFeatured classes="md:text-2xl">
								{language ? "Address:" : "Dirección:"}{" "}
							</SpanFeatured>
							José María Velasco 13, Benito Juárez, CDMX. C.P. 03900. México:
						</p>
						<div className="flex w-full mx-auto sm:text-xl">
							<p className="mx-auto my-3 sm:text-lg lg:text-xl">
						...
						<p className="mx-auto my-3 sm:text-xl">
